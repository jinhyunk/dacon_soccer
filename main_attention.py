...
def run_training():
    ...
    print("📂 데이터 로드 중...")
    # hierarchical_collate_fn2는 기존 Context-Aware용 Collate 함수를 그대로 사용
    ...
    # 모델 초기화 (Attention Model로 변경됨)
    model = PhaseAttentionHierarchicalLSTM(
    ...
    for epoch in range(Config.EPOCHS):
        ...
        #     # 파일명에 attention을 명시하여 저장
        #     save_name = f"attention_hierarchical_lr{Config.LR}_dist{best_dist_error:.4f}m.pth"
